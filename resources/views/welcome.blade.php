...
<body class="antialiased">
    <header class="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <a href="{{ route('register') }}" class="bg-black text-white px-5 py-2 rounded font-bold hover:bg-gray-800 transition">
            Sign Up
        </a>
    </header>
    ...
    <main class="max-w-2xl mx-auto px-8 py-16">
        ...
        <a href="{{ route('login') }}" class="inline-block bg-black text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-800 transition">
            Login
        </a>
    </main>
</body>
