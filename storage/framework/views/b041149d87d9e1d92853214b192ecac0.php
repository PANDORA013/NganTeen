...
<div class="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
        ...
        <form action="<?php echo e(route('penjual.menu.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <span class="text-sm text-gray-500"><?php echo e($menus->count()); ?> menu</span>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="p-4">
                            <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e($menu->nama_menu); ?></h4>
                            
                            <div class="space-y-2 mb-4">
                                <div class="flex justify-between items-baseline">
                                    <span class="text-sm text-gray-600">Harga</span>
                                    <span class="font-semibold text-orange-600">Rp <?php echo e(number_format($menu->harga, 0, ',', '.')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Stok</span>
                                    <span class="font-medium <?php echo e($menu->stok > 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e($menu->stok); ?>

                                    </span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Area</span>
                                    <span class="text-gray-800"><?php echo e($menu->area_kampus); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Warung</span>
                                    <span class="text-gray-800"><?php echo e($menu->nama_warung); ?></span>
                                </div>
                            </div>
...
<!-- Modal Edit Menu -->
<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="editMenu<?php echo e($menu->id); ?>" tabindex="-1" aria-labelledby="editMenuLabel<?php echo e($menu->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-white rounded-xl shadow-lg">
            ...
            <form action="<?php echo e(route('penjual.menu.update', $menu->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>                <div class="modal-body p-8">
                    <div class="space-y-6">
                        <?php if($menu->gambar): ?>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="harga" value="<?php echo e($menu->harga); ?>" required min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="stok" value="<?php echo e($menu->stok); ?>" required min="0"
                                   class="w-full rounded-md border-gray-300 px-4 py-2 focus:ring-2 focus:ring-black focus:border-black"
