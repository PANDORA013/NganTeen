...
<?php endif; ?>
    ...
    <div class="mt-4 text-center">
        <p class="text-sm text-gray-600">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-blue-500 hover:text-blue-700 hover:underline font-semibold">
                Daftar di sini
            </a>
        </p>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\NganTeen-main\resources\views/auth/login.blade.php ENDPATH**/ ?>